 ...
 */
 ...
 function horizontal_bar_submit(){
 	 ...
 	 $.ajax({
            ...
            cache: false,
            data: 'selected_month='+selected_month+'&selected_year='+selected_year+'&selected_line_year='+selected_line_year+'&dep_id='+dep_id+'&chart=horizontal_bar',
            beforeSend: function () {
...
function line_bar_submit(){
	 ...
	 var dep_id = $("#dep_id").val();
 	 $.ajax({
            ...
            headers: { 'Authorization': user_token },
            cache: false,
            data: 'selected_month='+selected_month+'&selected_year='+selected_year+'&selected_line_year='+selected_line_year+'&dep_id='+dep_id+'&chart=line',
            beforeSend: function () {
                $(".content-wrapper").LoadingOverlay("show",{
	 		  			 image       : "",
    					 fontawesome : "fa fa-cog fa-spin"
