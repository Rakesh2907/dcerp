                       ...
                       <?php 
                        ...
                        ?> 
                          <tr id="batch_row_id_<?php echo $batch['batch_id']?>">
                              ...
                              <td><input type="text" class="form-control inputs" name="outward_qty[<?php echo $sub_mat_id?>][<?php echo $batch['batch_id']?>]" value="<?php echo $batch['outward_qty']?>" id="sub_mat_outward_qty_<?php echo $sub_mat_id?>_<?php echo $batch['batch_id']?>" disabled="disabled"/></td>
                              <td><input class="form-control expire_date inputs" type="text" name="expire_date[<?php echo $sub_mat_id?>][<?php echo $batch['batch_id']?>]" value="<?php echo date("d-m-Y",strtotime($batch['expire_date']))?>" id="sub_mat_expire_date_<?php echo $sub_mat_id?>_<?php echo $batch['batch_id']?>" disabled="disabled"/></td>
