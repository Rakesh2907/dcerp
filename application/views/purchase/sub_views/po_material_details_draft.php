		 	...
		 	<tbody>
		 		<?php
		 			...
		 			<tr>
		 				...
		 				<td><input type="text" name="sgst_per[<?php echo $material['mat_id']?>]" value="<?php echo $material['sgst_per']?>" class="form-control" autocomplete="off" onkeyup="mypo_sgst_per(this.value,<?php echo $req_id?>,<?php echo $material['mat_id']?>)"></td>
		 				...
		 				<td><input type="text" name="igst_per[<?php echo $material['mat_id']?>]" value="<?php echo $material['igst_per']?>" class="form-control" autocomplete="off" onkeyup="mypo_igst_per(this.value,<?php echo $req_id?>,<?php echo $material['mat_id']?>)"></td>
