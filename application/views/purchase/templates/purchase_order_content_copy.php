...
<table width="100%" align="center" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse; margin-top: 2%">
              ...
              ?>
                 <tr style="padding: 0px;">
                    ...
                    <td style="font-size: 12px"><?php echo $value['hsn_code'];?></td>
                    <td style="font-size: 12px"><?php echo $value['unit_description'];?></td>
                    <td style="font-size: 12px"><?php echo $value['qty'];?></td>
                    <td style="font-size: 12px"><?php echo $value['rate'];?></td>
