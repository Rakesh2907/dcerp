<div class="clsTableParent" style="width:60%; clear:both;font-weight:bold;"> 
...
<table width="100%" align="center" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse; margin-top: 2%">
              ...
              <?php 
                 if(!empty($indent_material)){
                    $i = 1;
                    foreach ($indent_material as $key => $value) { //echo "<pre>"; print_r($value); echo "</pre>";  
              ?>
                 <tr style="padding: 0px;">
                    ...
                    <td></td> 
                    <td>
                        <?php if($value['cancel_requisition'] == '1'){?>
                               <small class="label" style="background:#f34723; color: #FFFFFF;">Cancel Requisition</small>
                        <?php }?>
                    </td> 
                 </tr> 
              <?php 
