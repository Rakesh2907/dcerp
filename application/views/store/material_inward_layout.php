...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="">Store</li>
        <li class="active">Material Inward</li>
      </ol>
</section>
<section class="content">
	<div class="box" style="border-top: 3px solid #F2C291;">
		    <div class="box-header">
              <div class="pull-left">
              		<a href="javascript:void(0)" class="btn btn-sm btn-primary" onclick="load_page('store/add_inward_material_form')">Add Materials</a>
              </div>
        </div>
                     ...
                     ?> 
                        <tr style="cursor: pointer;" data-row-id="<?php echo $value['inward_id']?>">
                          ...
                          <td>
                            ...
                            }else if($value['payment_status'] == 'check'){

                            }else if($value['payment_status'] == 'unpaid' /*&& $value['quality_status'] == 'uncheck'*/){ ?>
                                  <button style="cursor: pointer;" data-toggle="modal" onclick="load_page('store/edit_inward_material_form/inward_id/<?php echo $value['inward_id']?>')" rel="tooltip" class="edit_button_class" title="Edit/ Update"><i class="fa fa-pencil"></i></button>
                            <?php } ?>
                          </td>
                        </tr>  
                    <?php
