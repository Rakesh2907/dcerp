                        ...
                        <tr style="cursor: pointer;" data-row-id="<?php echo $value['inward_id']?>">
                          ...
                          <td>
                            <?php if($value['payment_status'] == 'unpaid' && $value['quality_status'] == 'uncheck'){ ?>
                                  <button style="cursor: pointer;" data-toggle="modal" onclick="load_page('store/edit_inward_material_form/inward_id/<?php echo $value['inward_id']?>')"><i class="fa fa-pencil"></i></button>
                            <?php } ?>
                          </td>
                        </tr>  
                    <?php
