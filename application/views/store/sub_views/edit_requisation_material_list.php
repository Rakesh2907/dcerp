				     	...
				     	?>
						    <tr id="material_id_<?php echo $material['mat_id']?>" data-row-id="<?php echo $material['id']?>">
						        ...
						        <td class="unitid_cls_<?php echo $material['mat_id']?>" width="100">
						        	 <select class="form-control valid" name="unit_id[<?php echo $material['mat_id']?>]" id="unit_id">
							        	 <?php 
							        	  	if(!empty($unit_list)){
						        ...
						        <td class="require_date_cls_<?php echo $material['mat_id']?>">
						        	...
						        	?>	
						        	  <div class="input-group date">
											...
											<input class="require_date form-control" name="require_date[<?php echo $material['mat_id']?>]" id="require_date[<?php echo $material['mat_id']?>]" size="10" value="<?php echo $require_date;?>" type="text" />	
						        	   </div>	
						        </td>
