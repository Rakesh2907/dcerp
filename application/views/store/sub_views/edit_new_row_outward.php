<tr id="batch_row_id_<?php echo $i?>_<?php echo $mat_id?>">
                  ...
                  <td>
                     <input type="text" class="form-control inputs" name="mat_bar_code[<?php echo $mat_id?>][]" value="" autocomplete="off" onblur="scan_barcode(this.value,<?php echo $mat_id?>,<?php echo $i?>,'edit')" id="mat_bar_code_<?php echo $i?>_<?php echo $mat_id?>"/>
                  </td>
                  <td>
                      <input type="text" class="form-control inputs" name="mat_batch_no[<?php echo $mat_id?>][]" value="" autocomplete="off" onblur="mat_batch_number(this.value,<?php echo $mat_id?>,<?php echo $i?>,'edit')" id="mat_batch_no_<?php echo $i?>_<?php echo $mat_id?>"/>
                  </td>
                  <td>
                      <input type="text" class="form-control inputs" name="mat_lot_no[<?php echo $mat_id?>][]" value="" autocomplete="off" onblur="mat_lot_number(this.value,<?php echo $mat_id?>,<?php echo $i?>,'edit')" id="mat_lot_no_<?php echo $i?>_<?php echo $mat_id?>"/>
                  </td>
                  ...
                  <td>
                      <input type="text" class="form-control inputs" name="mat_outward_qty[<?php echo $mat_id?>][]" value="0" autocomplete="off" onkeyup="change_stock(this.value,<?php echo $mat_id?>,<?php echo $i?>,'edit')" id="mat_outward_qty_<?php echo $i?>_<?php echo $mat_id?>"/>
                  </td>
                  ...
                  <td><button id="remove_button_<?php echo $i?>_<?php echo $mat_id?>" type="button" onclick="remove_row_outward(<?php echo $i?>,<?php echo $mat_id?>,'edit')">x</button></td>
</tr>