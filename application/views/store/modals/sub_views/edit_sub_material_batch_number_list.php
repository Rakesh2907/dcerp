                       ...
                       <?php 
                        ...
                        ?> 
                          <tr id="batch_row_id_<?php echo $batch['batch_id']?>">
                              ...
                              <td><input type="text" class="form-control inputs" name="batch_no[<?php echo $sub_mat_id?>][<?php echo $batch['batch_id']?>]" value="<?php echo $batch['batch_number']?>" id="sub_mat_batch_no_<?php echo $sub_mat_id?>_<?php echo $batch['batch_id']?>"  autocomplete="off"/><button type="button" onclick="create_batch_number_sub_material(<?php echo $sub_mat_id?>,<?php echo $batch['batch_id']?>)">Generate Batch No.</button></td>
